...
public class Album implements Serializable{
    ...
    public Album(Integer id, String title,
                 Integer count, String corverImg, Double score, String author,
                 String broadCast, String brife, Date publicDate, Date createDate,
                 String status, List<Chapter> children) {
        this.id = id;
        this.title = title;
        this.count = count;
